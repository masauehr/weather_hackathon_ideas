...
| 2026-09-02 | **⑤ 産地合成＋入荷量** | **ほうれんそう / 7官署** | 月次184（2011〜） | 合成でも価格 L1 β=+0.0103（t=+3.05, 前橋1点とほぼ同じ）。**入荷量の回帰で L0 β=−0.011(t=−4.6), L1 β=−0.010(t=−3.2)＝供給減が経路**（真夏日+10日→入荷量−15%）。冷涼産地への振り替え適応は確認できず | **機構確認** |

## 次にやること
1. **日次で埋める**: 2023年以前の日別価格を e-Stat「青果物卸売市場調査（日別調査）」から足し、週次でもラグ2〜4週の効果が立つか（月次より実用に近い早期警戒になる）。
