...
- [~] **ID-25 / CS-07 スパイク着手**（2026-09-02）: `experiments/cs07_veg_price/`。
  産地(諏訪)の週次日照平年比 → 2〜4週後の東京卸売価格 のラグ相関で GO/NO-GO。
  気象庁 etrn からの日照取得は自動で動作確認済み（2019〜2024, 諏訪/東京/静岡）。
  価格側は bot遮断のため手動DL 1回が必要（ベジ探 or 農水省xlsx → `data/cs07/veg_price_manual.csv`）。
